...
import net.mcreator.sfm.procedures.EmeraldarmorBodyTickEventProcedure;
...
public class EmeraldarmorItem extends SfmModElements.ModElement {
	@ObjectHolder("sfm_:emeraldarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sfm_:emeraldarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sfm_:emeraldarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sfm_:emeraldarmor_boots")
	public static final Item boots = null;
	public EmeraldarmorItem(SfmModElements instance) {
		super(instance, 12);
	}
