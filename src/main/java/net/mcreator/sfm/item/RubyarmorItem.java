...
public class RubyarmorItem extends SfmModElements.ModElement {
	@ObjectHolder("sfm_:rubyarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sfm_:rubyarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("sfm_:rubyarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("sfm_:rubyarmor_boots")
	public static final Item boots = null;
	public RubyarmorItem(SfmModElements instance) {
		super(instance, 36);
	}
