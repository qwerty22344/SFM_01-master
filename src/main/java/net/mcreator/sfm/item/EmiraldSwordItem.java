...
public class EmiraldSwordItem extends SfmModElements.ModElement {
	@ObjectHolder("sfm_:emirald_sword")
	public static final Item block = null;
	public EmiraldSwordItem(SfmModElements instance) {
		super(instance, 7);
	}
