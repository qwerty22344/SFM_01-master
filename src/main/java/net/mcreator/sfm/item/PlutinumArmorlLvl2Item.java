...
import net.mcreator.sfm.procedures.PlutinumArmorlLvl2BodyTickEventProcedure;
...
public class PlutinumArmorlLvl2Item extends SfmModElements.ModElement {
	@ObjectHolder("sfm_:plutinum_armorl_lvl_2_helmet")
	public static final Item helmet = null;
	@ObjectHolder("sfm_:plutinum_armorl_lvl_2_chestplate")
	public static final Item body = null;
	@ObjectHolder("sfm_:plutinum_armorl_lvl_2_leggings")
	public static final Item legs = null;
	@ObjectHolder("sfm_:plutinum_armorl_lvl_2_boots")
	public static final Item boots = null;
	public PlutinumArmorlLvl2Item(SfmModElements instance) {
		super(instance, 238);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("plutinum_armorl_lvl_2_helmet"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(null)) {
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				double z = entity.posZ;
				{
					...
					PlutinumArmorlLvl2BodyTickEventProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("plutinum_armorl_lvl_2_chestplate"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(null)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sfm_:textures/models/armor/plutinum_armor_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("plutinum_armorl_lvl_2_leggings"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.FEET, new Item.Properties().group(null)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "sfm_:textures/models/armor/plutinum_armor_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("plutinum_armorl_lvl_2_boots"));
	}
}
