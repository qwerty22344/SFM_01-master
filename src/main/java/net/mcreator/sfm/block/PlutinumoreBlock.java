...
public class PlutinumoreBlock extends SfmModElements.ModElement {
	@ObjectHolder("sfm_:plutinumore")
	public static final Block block = null;
	public PlutinumoreBlock(SfmModElements instance) {
		super(instance, 72);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("plutinumore", "plutinumore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 7), Placement.COUNT_RANGE, new CountRangeConfig(4, 0, 0, 56)));
		}
	}
}
