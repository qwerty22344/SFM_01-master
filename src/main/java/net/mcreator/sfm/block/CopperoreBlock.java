...
public class CopperoreBlock extends SfmModElements.ModElement {
	@ObjectHolder("sfm_:copperore")
	public static final Block block = null;
	public CopperoreBlock(SfmModElements instance) {
		super(instance, 68);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 14), Placement.COUNT_RANGE, new CountRangeConfig(20, 6, 6, 150)));
		}
	}
}
